...
const UnitsPage = ({ params }: Props) => {
  ...
  const getAllUnits = async () => {
    setLoading(true);
    const res = await TeacherServices.getAllUnits({ ...pagination, subjectId: params.subjectId, ...filters });
                ...
                <TableCell>
                  <div className="flex gap-2">
                    ...
                    <div
                      ...
                      onClick={() =>
                        router.push(
                          `/teacher/courses/${params.courseId}/semesters/${params.semesterId}/subjects/${subject?.id}/units/${unit.id}/materials`
                        )
                      }
                    >
                    ...
                    <div
                      ...
                      onClick={() =>
                        router.push(
                          `/teacher/courses/${params.courseId}/semesters/${params.semesterId}/subjects/${subject?.id}/units/${unit.id}/quiz`
                        )
                      }
                    >
                    ...
                    <DeleteTableAction
                      action={async () => {
                        await TeacherServices.deleteUnit(unit.id);
                        await getAllUnits();
                        toast({
                          title: "Unit Deleted",
